...
security_angle = linspace(20,60,5);
% security_angle = 40;
...
colors = jet(length(security_angle));
% colors = jet(length(security_circle_radius));


timeslots = 1000;

FS_interference = zeros(length(security_angle), timeslots);
BS_TXpower = cell(length(security_angle), timeslots);
...
figure(2)
title(['FS interference for R = ' num2str(radius(m)) ' and SA_{circle radius} = ' num2str(security_circle_radius)], 'FontSize', 14, 'FontWeight', 'bold')
...
legend(['SA_{angle} = ' num2str(security_angle(1))], ['SA_{angle} = ' num2str(security_angle(2))] , ['SA_{angle} = ' num2str(security_angle(3))], ['SA_{angle} = ' num2str(security_angle(4))], ['SA_{angle} = ' num2str(security_angle(5))])
% legend(['SA_{circle radius} = ' num2str(security_circle_radius(1))], ['SA_{circle radius} = ' num2str(security_circle_radius(2))] , ['SA_{circle radius} = ' num2str(security_circle_radius(3))], ['SA_{circle radius} = ' num2str(security_circle_radius(4))], ['SA_{circle radius} = ' num2str(security_circle_radius(5))])
% saveas(figure(2), 'FS_interference.jpg')

figure(3)
title(['BS Tx power for R = ' num2str(radius(m)) ' and SA_{circle radius} = ' num2str(security_circle_radius)], 'FontSize', 14, 'FontWeight', 'bold')
...
legend(['SA_{angle} = ' num2str(security_angle(1))], ['SA_{angle} = ' num2str(security_angle(2))] , ['SA_{angle} = ' num2str(security_angle(3))], ['SA_{angle} = ' num2str(security_angle(4))], ['SA_{angle} = ' num2str(security_angle(5))])
% legend(['SA_{circle radius} = ' num2str(security_circle_radius(1))], ['SA_{circle radius} = ' num2str(security_circle_radius(2))] , ['SA_{circle radius} = ' num2str(security_circle_radius(3))], ['SA_{circle radius} = ' num2str(security_circle_radius(4))], ['SA_{circle radius} = ' num2str(security_circle_radius(5))])
% saveas(figure(3), 'BS_Txpower.jpg')
