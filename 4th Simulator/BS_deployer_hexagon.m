function [ BS ] = BS_deployer_hexagon(x_first_bs, y_first_bs, h_BS, area_of_interest, FS ) 

global radius
global m

up_border_area_of_interest = area_of_interest/2;
down_border_area_of_interest = -area_of_interest/2;
left_border_area_of_interest = -area_of_interest/2;
right_border_area_of_interest = area_of_interest/2;
